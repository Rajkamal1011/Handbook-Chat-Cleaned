...
# File path
file_path = "/home/rajkamal/Desktop/New_ERA/NLP/RAG/Evaluation/comet/tabular_COMET_openai_no_as_far_as.xlsx"
...
#filtered_df = df[~df['Tabular Responses'].str.contains('|'.join(bad_retrieval_texts), case=False, na=False)]
